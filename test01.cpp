...
int main()
{
	...
	const int sample_number = 7;
	Mat img = Mat::zeros(height, width, CV_8UC3);

	// 训练样本
	float train_data[sample_number][2] = { { 500, 60 },{ 245, 40 },{ 480, 250 },{ 160, 380 },{400, 25},{55, 400} , {300,300}};
	float labels[sample_number] = {0,0,0,1,0,1, 1};  // 每个样本数据对应的输出
	
	Mat train_data_mat(sample_number, 2, CV_32FC1, train_data);
	Mat labels_mat(sample_number, 1, CV_32FC1, labels);
